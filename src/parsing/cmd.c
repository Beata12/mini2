...
// 			&& check_special_symbol(shell_data->tokarr[*token_index].word) == 2)
// 			handle_double_redirection(&shell_data->cmdarr[command_index].inp[++current_input], shell_data->tokarr,
// 				token_index);
// 		if (shell_data->tokarr[*token_index].type == T_RED_FROM
...
// 		else
// 			shell_data->cmdarr[command_index].args[++current_arg] = shell_data->tokarr[*token_index].word;
// 		(*token_index)++;
// 	}
// }
...
// 			handle_double_redirection(&shell_data->cmdarr[cmd].inp[++i], shell_data->tokarr,
// 				tok);
// 		if (shell_data->tokarr[*tok].type == T_RED_FROM
