...
//         exit(EXIT_FAILURE);
//     }
//     command->input_tokens = ft_malloc(sizeof(t_token)
//* cmd_sizes.input_count);
//     if (!command->input_tokens)
//     {
//         // Obsługa błędu alokacji pamięci
//         perror("Failed to allocate memory for input redirections");
...
//             count->output_count++;
//         }
//         if (token->type == T_RED_FROM && check_special_symbol
//(token->word) == 2)
//         {
//             count->output_count++;
//         }
...
// 	        (*token_counter)++;
// 	}
// 	// while (shell_data->tokarr && *token_counter < shell_data->tokarr_l
//&& shell_data->tokarr[*token_counter].word
...
// 	allocate_command_memory(count,
//&shell_data->command_array[command_counter]);
// }
// //zrobione
// void	initialize_command_array(t_args *shell_data)
// {
