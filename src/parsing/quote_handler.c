...
// 	// while (*current_token.word && current_token.type == T_WORD)
// 	// {
// 	// 	if (!(quote_status == *current_token.word || 
//(!quote_status && *current_token.word == quote(*current_token.word))))
// 	// 	{
// 	// 		i++;
// 	// 	}
...
//&& current_char != track_quote(current_char)))
// 			is_open_quote(current_char, &quote_status);
// 		if (!(quote_status == current_char || 
//(!quote_status && current_char == track_quote(current_char))))
// 			i++;
// 		current_token.word++;
// 	}
// 	processed_word = ft_calloc(sizeof(char), i + 1);
...
// 	// {
// 	// 	if (!(quote_status == current_token->word[i] || 
//(!quote_status && current_token->word[i] == 
//quote(current_token->word[i]))))
// 	// 	{
// 	// 		processed_word[new_index] = current_token->word[i];
// 	// 		new_index++;
// 	// 	}
