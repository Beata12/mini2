...
//|| (is_whitespace(src[i]) && (!output_index
...
// 			continue;
// 		}
// 		if (is_whitespace(src[i]) && (!output_index
//|| !src[i + 1]) && !quote_status)
// 		{
// 			i++;
// 			continue;
...
// }
// //zrobione
// static void	expand_env_variables(char **input_string,
//t_args *shell_data)
// {
// 	int		i;
// 	char	quote_status;
...
// 	//         break;
// 	//     expand_dollar_variables(&divided_strings[i],
//&quote_status, shell_data);
// 	//     i++;
// 	// }
// 	while (divided_strings[i])
// 	{
...
// 	free_string_array(divided_strings);
// }
// // static void	expand_env_variables(char **s, 
//t_args *shell_data)
// // {
// // 	char	**dllr_arr;
// // 	int		i;
...
// // }
// //ZROBIONE I DZIALA!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// static void	split_tokens(char *input_string,
//t_args *shell_data)
// {
// 	int	i;
// 	int	token_index;
...
// 			token_length =
//skip_special_characters(&input_string[i]);//DZIAŁA!!!!!!!!!!!!!!!!!!
// 		shell_data->token_array[token_index].word
//= ft_substr(input_string, i, token_length--);
// 		i += token_length;
// 		token_index++;
// 	}
// }
...
// 	while (command_counter < shell_data->command_count)
// 	{
// 		parse_and_fill_command(command_counter,
//&token_counter, shell_data);//tutaj
// 		token_counter++;
// 		command_counter++;
// 	}
// }
